...
@SuppressWarnings("static-method") public final class TestAssumptionFailed
{
  /**
   * Default constructor.
   */

  public TestAssumptionFailed()
  {
  ...
  @Test public void testPassOne()
  {
    ...
    System.out.println(TestAssumptionFailed.class.getCanonicalName()
      + ": testPassOne");
  }
}
